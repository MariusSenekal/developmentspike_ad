  ...
  app: {
    head: {
      ...
      meta: [
        ...
        { property: 'og:image', content: 'https://developmentspike.co.za/og-image.png?v=20251228b' },
        { property: 'og:image:secure_url', content: 'https://developmentspike.co.za/og-image.png?v=20251228b' },
        { property: 'og:image:url', content: 'https://developmentspike.co.za/og-image.png?v=20251228b' },
        ...
        { name: 'twitter:image', content: 'https://developmentspike.co.za/og-image.png?v=20251228b' },
