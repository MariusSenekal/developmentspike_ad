  ...
  app: {
    head: {
      ...
      meta: [
        ...
        { property: 'og:image', content: 'https://developmentspike.co.za/og-image.png' },
        { property: 'og:image:secure_url', content: 'https://developmentspike.co.za/og-image.png' },
        { property: 'og:image:url', content: 'https://developmentspike.co.za/og-image.png' },
        ...
        { name: 'twitter:image', content: 'https://developmentspike.co.za/og-image.png' },
